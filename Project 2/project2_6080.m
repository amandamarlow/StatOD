...
% sigma_SNC = 1e-6;
% Qc = diag(sigma_SNC^2*ones(1,3));
% [X_3_lkf, Xref_3_lkf, dx_3_lkf, P_3_lkf, y_3_lkf, alpha_3_lkf] = CKF_proj2(tspan_3, data_3, meas_cov, Qc, X0_2, zeros(n,1), P0_2, 15, false, constants);
...
% P_DCO_lkf = X_3_lkf(:,:,end);
% [~, r3SOI_3, v3SOI_3, P_3SOI] = propogateTo3RSOI(tspan_3(end), X_DCO_lkf, P_DCO_lkf);
% varyShat = false;
