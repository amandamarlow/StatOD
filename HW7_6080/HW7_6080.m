...
% [x_UKF, P_UKF, preFit_UKF] = UKF(tspan, YJ3_simulated, R, Qc, X0+dx0, P0, alpha, beta, constants);
% error_UKF = x_UKF - XtrueJ3;
% 
% alpha = 10^-4;
% [x_UKF, P_UKF, preFit_UKF] = UKF(tspan, YJ3_simulated, R, Qc, X0, P0, alpha, beta, constants);
% error_UKF = x_UKF - XtrueJ3;
...
% plotResiduals_HW3(tspan, preFit_EKF_SNC, postFit_EKF_SNC, noise_sd, titles)
% plotErrorAndBounds_HW3(tspan, error_EKF_SNC, P_EKF_SNC, "EKF-SNC Error vs Time")

% titles = ["UKF Pre-Fit Residuals vs. Time", "UKF Post-Fit Residuals vs. Time"];
% % plotResiduals_HW3(tspan, preFit_UKF, postFit_UKF, noise_sd, titles)
